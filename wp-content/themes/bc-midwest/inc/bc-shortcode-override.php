...
ob_start();
    ?>
<div class="container position-relative my-4 py-lg-3 px-4">
...
<div class="container-fluid" <?php if(get_current_blog_id() == 2){?> style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/comm_content_bg.jpg); background-size:cover; background-repeat: no-repeat;"<?php }?> >
    <div class="container">
...
<?php }?>
 ...
 <div class="swiper-slide">
  ...
  <div class="inner-box position-relative w-75 w-sm-100 mw-100 p-4 bc_color_3  my-5 bc_color_3_bg text-center mobile_permotion">
...
<!-- Add Pagination -->
<div class="swiper-pagination d-lg-none d-xs-block test_swiper"></div>
 <!-- Add Arrows--->
