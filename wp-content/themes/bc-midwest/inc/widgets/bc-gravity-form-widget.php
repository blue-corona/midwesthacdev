...
class BC_Gravity_Widget extends WP_Widget {
 ...
 <div class="bc_color_primary_bg py-4 text-center d-none d-lg-block">


        <span class="bc_text_25 bc_font_alt_1 bc_color_white  bc_text_light bc_line_height_30">
                  <?php 
				if ( isset( $instance['title'] ) && !empty($instance['title']) ) {
					echo  $instance['title']; 
				}else{
					echo 'Talk to An <span class="bc_text_bold">Expert</span> Today';
				}
			?>
        	 </span>
