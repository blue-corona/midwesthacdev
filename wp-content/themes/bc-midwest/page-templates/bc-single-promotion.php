				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-12 mt-2 px-5">
						...
						<div class="no-print">
							...
							<button class="btn btn-warning hvr-sweep-to-right">Send Request</button>

<button class="btn btn-primary hvr-sweep-to-right">Learn More</button>

<button class="btn btn-secondary hvr-sweep-to-right">Get Details</button>
						</div>
					</div>
				</div>
			</div>
