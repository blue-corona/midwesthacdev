...
?>
<?php echo bc_get_theme_mod('bc_theme_options', 'footer','copyright_text', '<div class="bc_color_primary_bg  mobile_copyright_bar py-2 desktop_copyright ">
	<div class="container bc_color_white bc_text_15 bc_font_default pl-lg-5 bc_sm_line_height_19 bc_line_height_28 mobile_center_text">
...
<div class="h-100 modal fade bc_color_primary_bg" id="myModal_mobile" tabindex="-1" role="dialog" aria-labelledby="disclaimerLabel" aria-hidden="true" style="        overflow-y: hidden !important;">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content rounded-0 bc_color_primary_bg position-relative mt-n5" style="height: 500px; z-index:100001; border:none;">
      ...
      <div class="modal-body p-0 ">
        <div class="">
          ...
          <span class="d-block bc_text_25 bc_line_height_30 text-white bc_font_alt_1 text-center  mb-2">Talk to An <span class="bc_text_bold">Expert</span> Today </span>
                ...
                if(get_current_blog_id() == 1){
                  ...
                  echo do_shortcode('[gravityform id=4 ajax=true]');
                }
                ?>
                </div>
            </div>
