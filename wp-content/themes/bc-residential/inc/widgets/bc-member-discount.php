...
//Add JS for widget to footer
	...
	add_action('wp_footer', function() use ( $widgetInstance ) { 
		...
		?>
	<div class="p-lg-5">
		<div class="bc_color_tertiary_bg px-3 text-center pb-5" style=" box-shadow: 0 6px 16px 9px rgba(0,0,0,0.2);">
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/medal_sidebar.svg">

		<?php 
		if ( isset( $instance['title'] ) && !empty($instance['title']) ) {
		echo $args['before_title'] . $instance['title'] . $args['after_title']; 
		}else{
		echo '<h5 class="my-3 bc_color_4 ">Member Discount</h5>';
		}
		?>
		<h4 class="h4-alt bc_color_4 "><?php echo $instance['text_description'];?></h4>
