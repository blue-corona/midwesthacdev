...
<p><button class="btn btn-warning hvr-sweep-to-right">Send ttt Request</button></p>
<p><button class="btn btn-primary hvr-sweep-to-right">Learn More</button></p>
<p><button class="btn btn-secondary hvr-sweep-to-right">Get Details</button></p>
<hr>
<ul class="subpage">
<li>abcd</li>
<li>abcd</li>
